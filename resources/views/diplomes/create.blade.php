...
<div class="flex">
    ...
    <div class="container mx-auto px-4 py-8 w-55">
        <h1 class="text-3xl font-bold mb-6">Diplome Registration</h1>
        <form action="{{route('diplomes.store')}}" method="POST"  enctype="multipart/form-data">
            @csrf

            <div class="flex flex-wrap -mx-3 mb-6">

                <div class="w-full md:w-1/2 px-3 mt-7 md:mb-0">

                    <select name="cin" id="cin" class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:ring-w-1 text-gray-700 shadow-sm" required>

                        @foreach ($agens as $agen)

                            <option value="{{ $agen->cin }}">{{ $agen->cin }}</option>
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input type="text" name="ID_Dipolm" id="ID_Dipolm" class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:ring-w-1 text-gray-700 shadow-sm" required>
                </div>
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Nom:</label>
                    <input type="text" name="name" id="name" class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:ring-w-1 text-gray-700 shadow-sm" required>
                </div>
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <label for="institution" class="block text-sm font-medium text-gray-700 mb-2">Instut</label>
                    <input type="text" name="institution" id="institution" class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:ring-w-1 text-gray-700 shadow-sm" required>
                </div>
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <label for="filliere" class="block text-sm font-medium text-gray-700 mb-2">Domaine</label>
                    <input type="text" name="filliere" id="filliere" class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:ring-w-1 text-gray-700 shadow-sm">
                </div>
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input type="text"
                           name="mention"
                           id="mention" class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:ring-w-1 text-gray-700 shadow-sm" required>
                </div>
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <label for="date_obtenu" class="block text-sm font-medium text-gray-700 mb-2">Date_Obtenu:</label>
                    <input type="date" name="date_obtenu" id="date_obtenu"
